...
import { data } from '../tracking-database/filterUtils'
...
function normalizeSatkerKey(s: string | null | undefined) {
...
export default function TrackingSatuanKerja() {
  ...
  const [fRank, setFRank] = useState<string | null>(null)
                    ...
                    rows.map((r) => {
                      ...
                      return (
                        <React.Fragment key={r._id}>
                          ...
                          {isExpanded && (
                            <tr className='bg-gradient-to-b from-blue-50/60 to-blue-50/20'>
                              <td
                                colSpan={8}
                                    ...
                                    <div className='grid grid-cols-1 gap-2 max-h-80 overflow-y-auto pr-1'>
                                      {visitDates.map((v) => {
                                        ...
                                        return (
                                          ...
                                          >
                                            <div className='flex-shrink-0 grid h-10 w-10 place-items-center rounded-lg bg-blue-50 text-blue-600 group-hover:bg-blue-100 transition-colors'>
                                              <Calendar className='w-4 h-4' />
                                            </div>
